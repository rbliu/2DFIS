...
config.measurement.plugins.names=['base_PixelFlags', 'base_GaussianFlux', 'base_Blendedness', 'base_CircularApertureFlux', 'ext_shapeHSM_HsmPsfMoments', 'base_SdssCentroid', 'ext_shapeHSM_HsmShapeKsb', 'base_NaiveCentroid', 'base_LocalBackground', 'ext_shapeHSM_HsmSourceMoments', 'base_InputCount', 'base_PsfFlux', 'ext_shapeHSM_HsmShapeRegauss', 'ext_photometryKron_KronFlux', 'base_SkyCoord', 'base_Variance', 'modelfit_DoubleShapeletPsfApprox', 'modelfit_CModel', 'base_SdssShape']
# whether to run this plugin in single-object mode
...
config.match.refObjLoader.filterMap={'u2': 'U', 'g2': 'G', 'r2': 'R', 'i3': 'I'}
...
config.connections.refCat='sdss'
