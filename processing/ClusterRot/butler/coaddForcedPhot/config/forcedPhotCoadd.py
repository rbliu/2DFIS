...
config.measurement.plugins.names=['base_InputCount', 'base_CircularApertureFlux', 'base_TransformedShape', 'base_GaussianFlux', 'base_Variance', 'base_LocalBackground', 'ext_photometryKron_KronFlux', 'base_SdssShape', 'base_PixelFlags', 'base_TransformedCentroid', 'modelfit_DoubleShapeletPsfApprox', 'modelfit_CModel', 'base_PsfFlux', 'base_SdssCentroid']
# whether to run this plugin in single-object mode
