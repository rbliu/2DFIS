...
# Specify a job name:
#SBATCH -J FRB190417_proc

# Specify an output file
# %j is a special variable that is replaced by the JobID when 
# job starts
#SBATCH -o j_FRB190417_proc-%j.out
#SBATCH -e j_FRB190417_proc-%j.out
...
processCcd.py DATA @list_process_u.list --rerun processCcdOutputs_noct -C config/processCcdConfig_u.py --clobber-config -j ${cpunum} --longlog
