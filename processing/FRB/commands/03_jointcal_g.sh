...
# Specify a job name:
#SBATCH -J FRB190417_jc_g

# Specify an output file
# %j is a special variable that is replaced by the JobID when 
# job starts
#SBATCH -o j_FRB190417_jc_g-%j.out
#SBATCH -e j_FRB190417_jc_g-%j.out
...
jointcal.py DATA --rerun coadd:jointcal_g -C config/jointcal_config.py @list_jc_g.list -j ${cpunum} --clobber-config --longlog
