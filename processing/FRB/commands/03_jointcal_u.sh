...
# Specify a job name:
#SBATCH -J FRB190417_jc_u

# Specify an output file
# %j is a special variable that is replaced by the JobID when 
# job starts
#SBATCH -o j_FRB190417_jc_u-%j.out
#SBATCH -e j_FRB190417_jc_u-%j.out
...
jointcal.py DATA --rerun coadd:jointcal_u -C config/jointcal_config.py @list_jc_u.list -j ${cpunum} --clobber-config --longlog
