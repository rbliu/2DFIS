...
# Specify a job name:
#SBATCH -J FRB190417_jc_r

# Specify an output file
# %j is a special variable that is replaced by the JobID when 
# job starts
#SBATCH -o j_FRB190417_jc_r-%j.out
#SBATCH -e j_FRB190417_jc_r-%j.out
...
jointcal.py DATA --rerun coadd:jointcal_r -C config/jointcal_config.py @list_jc_r.list -j ${cpunum} --clobber-config --longlog
