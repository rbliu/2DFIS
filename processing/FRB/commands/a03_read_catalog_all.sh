...
#SBATCH -n 1
#SBATCH --mem=16G
#SBATCH -J read_catalog_all_FRB
#SBATCH -o read_catalog_all_FRB-%j.out 
#SBATCH -e read_catalog_all_FRB-%j.out 
...
python ${script_folder}/load_dm_output_all_new.py ${patches} ${dm_csv} ${DATA_folder} 
