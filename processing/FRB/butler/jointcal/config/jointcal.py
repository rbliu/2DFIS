...
config.astrometryRefObjLoader.filterMap={'u': 'phot_g_mean_mag', 'u2': 'phot_g_mean_mag', 'g': 'phot_g_mean_mag', 'g2': 'phot_g_mean_mag', 'r': 'phot_g_mean_mag', 'r2': 'phot_g_mean_mag', 'i': 'phot_g_mean_mag', 'i2': 'phot_g_mean_mag', 'i3': 'phot_g_mean_mag', 'z': 'phot_g_mean_mag', 'z2': 'phot_g_mean_mag'}
...
# Mapping of camera filter name: reference catalog filter name; each reference filter must exist
config.photometryRefObjLoader.filterMap={'u': 'g', 'u2': 'g', 'g': 'g', 'g2': 'g', 'r': 'r', 'r2': 'r', 'i': 'i', 'i2': 'i', 'i3': 'i', 'z': 'z', 'z2': 'z'}
